...
python3 ~/.claude/skills/screenshot-eval/scripts/screenshot.py --window "WindowTitle"

# With delay for slow-loading apps
python3 ~/.claude/skills/screenshot-eval/scripts/screenshot.py --window "WindowTitle" --delay 2
```

Read the screenshot with the Read tool to see what's on screen.
...
```bash
python3 ~/.claude/skills/gui-debugger/scripts/activate_window.py "WindowTitle"
```
