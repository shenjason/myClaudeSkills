...
`~/.codeium/windsurf/skills/gui-debugger/agents/visual-inspector.md` and adapt it for the specific app.
...
```bash
python3 ~/.codeium/windsurf/skills/gui-debugger/scripts/tile_windows.py "App1" "App2"
```
...
found), check `~/.codeium/windsurf/skills/gui-debugger/references/troubleshooting.md` for recovery steps.
...
```bash
python3 ~/.codeium/windsurf/skills/gui-debugger/scripts/screenshot_diff.py before.png after.png
```
