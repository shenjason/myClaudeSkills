...
Use the Read tool on the printed file path to view the image:

```
Read /tmp/screenshot_20260321_143022.png
```

Claude can see images. Examine the screenshot and answer:
...
# 3. Read and evaluate
# (use Read tool on the path above)
```
